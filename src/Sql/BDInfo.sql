...
--DISTRICTS
Select districts.Districtname from districts inner join division on 
division.divisionid=districts.DivisionId where Division.DivisionName = 'Rajshahi'

Select districts.Districtname from districts inner join division on 
division.divisionid=districts.DivisionId where Division.DivisionName= 'dhaka' 

Select Upazilas.UpazilaName from Upazilas inner join districts on
	Upazilas.DistrictId = districts.DistrictId where districts.DistrictName = 'naogaon'
